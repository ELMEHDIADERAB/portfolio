...
import {
  ...
  hasModifierKey,
  mixinColor
} from "./chunk-PPYC2XLB.js";
import "./chunk-LHZXSDHI.js";
import {
  animate,
  animateChild,
  group,
...
var MatIcon = class _MatIcon extends _MatIconBase {
  ...
  constructor(elementRef, _iconRegistry, ariaHidden, _location, _errorHandler, defaults) {
    ...
    this._currentIconFetch = import_rxjs2.Subscription.EMPTY;
    if (defaults) {
      if (defaults.color) {
...
var MatStep = class _MatStep extends CdkStep {
  constructor(stepper, _errorStateMatcher, _viewContainerRef, stepperOptions) {
    ...
    this._viewContainerRef = _viewContainerRef;
    this._isSelected = import_rxjs3.Subscription.EMPTY;
    this.stepLabel = void 0;
  }
  ngAfterContentInit() {
    this._isSelected = this._stepper.steps.changes.pipe((0, import_operators3.switchMap)(() => {
      return this._stepper.selectionChange.pipe((0, import_operators3.map)((event) => event.selectedStep === this), (0, import_operators3.startWith)(this._stepper.selected === this));
...
var MatStepper = class _MatStepper extends CdkStepper {
  ...
  ngAfterContentInit() {
    ...
    this.steps.changes.pipe((0, import_operators3.takeUntil)(this._destroyed)).subscribe(() => {
      this._stateChanged();
    });
    this._animationDone.pipe(
      ...
      (0, import_operators3.distinctUntilChanged)((x, y) => x.fromState === y.fromState && x.toState === y.toState),
